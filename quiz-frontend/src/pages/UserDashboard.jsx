          ...
          {topics.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {topics.map((topic, index) => (
                <div
                  key={topic.id}
                  className={`cursor-pointer rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.03] transition transform p-6 bg-gradient-to-br ${
                    topicBgColors[index % topicBgColors.length]
                  }`}
                  style={{
                ...
                >
                  ...
                  <div
                    className="mt-2 text-indigo-600 font-medium underline"
                    onClick={() => navigate(`/practicequiz/${topic.id}`)}
                  >
                    Start Practice Quiz →
                  </div>
                </div>
